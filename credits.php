...
<body>
	...
	<li><a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe">Mozilla Developer Network - HTML Iframe Element</a> (Accessed on: 03 April 2025) provided detailed iframe usage and attributes, implemented in `example_results.php` and `analyze.php` for embedding MSA and motif outputs.</li>
        <li><a href="https://www.w3schools.com/html/html_iframe.asp">W3Schools - HTML Iframe</a> (Accessed on: 03 April 2025) offered practical iframe examples, adapted in `example_results.php` and `advanced.php` for displaying analysis reports and text outputs.</li>
